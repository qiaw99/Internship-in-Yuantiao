...
public class PageController {
	...
	@RequestMapping(value = "/realtime.html")
	public String realtime(Model m, HttpSession session) {
		return "page/realtime";
	}
	
	@RequestMapping(value = "/crossPop.html")
	public String crossPop(Model m, HttpSession session) {
		return "page/crossPop";
	}
...
//		List<AppBo> apps = appService.getAll();
		List<AppBo> apps = userService.getAppsByName(userBo.getName());
